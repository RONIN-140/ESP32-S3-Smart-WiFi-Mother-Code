...
This is a production-ready template for the **ESP32-S3-WROOM (Dual Type-C) and other versions of ESP32** and **0.96" SSD1306 OLED Display**. It runs your project code smoothly while handling Wi-Fi network shifting and OTA in the background.
